...
contract FINN is RERC20 {
    ...
    constructor(uint256 initialSupply)
        public
        RERC20(initialSupply, "FINN Token", "FINN", 18, 100)
    {}
}

// File: contracts/MasterChefUtil.sol
...
// MasterChefUtil is the master of FINN. He can make FINN and he is a fair guy.
//
...
contract MasterChefUtil is Ownable {
    using SafeMath for uint256;
        ...
        returns (uint256)
    {
        ...
        if (block.timestamp > pool.lastRewardTimestamp && lpSupply != 0) {
            ...
            uint256 finnReward = multiplier
                .mul(finnPerSecond)
                .mul(pool.allocPoint)
                .div(totalAllocPoint);
            accRewardPerShare = accRewardPerShare.add(
                finnReward.mul(1e12).div(lpSupply)
            );
        }
        return
    ...
    // Deposit LP tokens to MasterChefUtil for FINN allocation.
    ...
    // Withdraw LP tokens from MasterChefUtil.
