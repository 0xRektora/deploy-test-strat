...
// File: contracts/interfaces/ILiquidityPair.sol
...
// File: contracts/LiquidityPair.sol
...
contract LiquidityPair is HuckleberryERC20 {
    using SafeMath for uint256;
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "Huckleberry: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "Huckleberry: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "Huckleberry: INSUFFICIENT_LIQUIDITY"
        );
        ...
        uint256 balance1;
        {
            ...
            if (data.length > 0)
                IHuckleberryCallee(to).huckleberryCall(
                    msg.sender,
                    amount0Out,
                    amount1Out,
                    data
        ...
        require(
            ...
            "Huckleberry: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
...
// File: contracts/HuckleberryFactory.sol
...
contract HuckleberryFactory is IHuckleberryFactory {
        ...
        returns (address pair)
    {
        ...
        require(
            ...
            "Huckleberry: PAIR_EXISTS"
        ); // single check is sufficient

        pair = (address)(new LiquidityPair());
