...
interface RERC20Interface extends ethers.utils.Interface {
  functions: {
    ...
    "updateTaxFee(uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(functionFragment: "maxTaxFee", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "maxTaxFee", data: BytesLike): Result;
  ...
  events: {
    ...
    "UpdateTaxFee(uint256,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "Approval"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Transfer"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "UpdateTaxFee"): EventFragment;
}
...
export type UpdateTaxFeeEvent = TypedEvent<
  [BigNumber, BigNumber] & { previousTaxFee: BigNumber; newTaxFee: BigNumber }
>;

export class RERC20 extends BaseContract {
  ...
  functions: {
    ...
    maxTaxFee(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    updateTaxFee(_fee: BigNumberish, overrides?: CallOverrides): Promise<void>;
  };
  ...
  filters: {
    ...
    "UpdateTaxFee(uint256,uint256)"(
      previousTaxFee?: null,
      newTaxFee?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
      { previousTaxFee: BigNumber; newTaxFee: BigNumber }
    >;
  ...
  populateTransaction: {
    ...
    maxTaxFee(overrides?: CallOverrides): Promise<PopulatedTransaction>;
