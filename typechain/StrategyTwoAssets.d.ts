...
interface StrategyTwoAssetsInterface extends ethers.utils.Interface {
  functions: {
    "FARM_MASTER_CHEF()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "FARM_MASTER_CHEF",
    values?: undefined
  ): string;
...
export class StrategyTwoAssets extends BaseContract {
  ...
  interface: StrategyTwoAssetsInterface;

  functions: {
    FARM_MASTER_CHEF(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    FARM_MASTER_CHEF(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    FARM_MASTER_CHEF(overrides?: CallOverrides): Promise<PopulatedTransaction>;
