...
interface IHuckleberryFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IHuckleberryFactory extends BaseContract {
  ...
  interface: IHuckleberryFactoryInterface;
