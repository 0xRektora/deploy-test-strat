...
interface HuckleberryFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class HuckleberryFactory extends BaseContract {
  ...
  interface: HuckleberryFactoryInterface;
